...
#
"""
This example shows how one can use individual previous retrofits. 
This includes different constructions that have the same u-value than newer constructions.
"""
...
if __name__ == "__main__":
    ...
    output_dir = __abs_path("../results/previous_retrofits")
